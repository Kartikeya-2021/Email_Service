...
@SlingServletResourceTypes(resourceTypes = "wknd/components/", methods = { HttpConstants.METHOD_GET,
        HttpConstants.METHOD_POST }, extensions = "html")
...
public class SimpleServlet extends SlingAllMethodsServlet {
    ...
    protected void doPost(SlingHttpServletRequest req, SlingHttpServletResponse resp)
        ...
        resp.getWriter().write("THANK YOU!! YOUR FORM HAS BEEN REGISTERED");
    }
}
